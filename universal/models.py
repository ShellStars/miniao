...
class Universalclass(models.Model):
    ...
    class Meta:
        verbose_name = '科普园地栏目'
        verbose_name_plural = '科普园地栏目'
        ordering = ['name']  # 排序


@python_2_unicode_compatible
class Universalarticle(models.Model):
    column = models.ForeignKey(Universalclass, verbose_name='归属栏目')
